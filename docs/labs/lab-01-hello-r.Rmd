...
subtitle: "due Tue, September 3 at 11:59p"
output: 
  tufte::tufte_html:
    css: "./sta199-labs.css"
...
- Go to the sta199-fa19 organization on GitHub ([https://github.com/sta199-fa19](https://github.com/sta199-fa19)). Click on the repo with the prefix **lab-01-hello-r-**. It contains the starter documents you need to complete the lab.
...
- Go to [https://vm-manage.oit.duke.edu/containers](https://vm-manage.oit.duke.edu/containers) and login with your Duke NetID and Password.

- Click to log into the Docker container RStudio - statistics application with Rmarkdown and knitr support. You should now see the RStudio environment, just as in class.


- Go to **File** $\rightarrow$ **New Project** $\rightarrow$ **Version Control** $\rightarrow$ **Git**.

- **Paste the URL**  of your assignment repo into the dialog box **Repository URL**. You can leave **Project Directory Name** empty. It will default to the name of the GitHub repo.
## Configure git
...
- For the last line, “Create project as subdirectory of,” click on “Browse,” and browse to an appropriate folder. In this case, I **created a new folder named** “lab-01” where this project will live.

- Click **Create Project**, and log in using your GitHub credentials. Once you have successfully logged in, the files from your GitHub repo will be displayed in the **Files** pane in RStudio - you have successfully cloned your repo into RStudio!


```{r clone-user, fig.margin = TRUE, echo = FALSE, fig.width=3}
knitr::include_graphics("img/01-hello-r/clone_user.png")
```
...
```{r eval=FALSE}
library(usethis)
use_git_config(user.name="Becky Tang", user.email="becky.tang@duke.edu")
```
...
Then go to the Git pane in your RStudio. This will be in the top right hand corner in a separate tab.
...
- Mark the pages associated with each exercise, 1 - 5. All of the papers of your lab should be associated with at least one question (i.e., should be “checked”). If the questions are not associated, then the TA might not be able to see them when grading!
