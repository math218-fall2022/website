...
- Go to the STA210-Sp19 organization on GitHub ([https://github.com/STA210-Sp19](https://github.com/STA210-Sp19)). Click on the repo with the prefix **lab-01-hello-r-**. It contains the starter documents you need to complete the lab.
...
- Hit OK, and you should see the contents from your GitHub repo in the Files pane in RStudio. 
...
If you need to install the packages, you can run the code below in the console.  
...
Now you can Knit your document and see the results. 
...
6. Resize the figures in exercises 2, 3, 4 to make them square. 
