...
| `sex` 		       | Sex of professor: female, male
...
4.  Replot the scatterplot from Exercise 3, but this time use  `geom_jitter()`? What does "jitter" mean? 
...
10.  Fit a new linear model called `m_gen` to predict average professor evaluation `score` 
    based on `sex` of the professor. Based on the regression output, write the linear 
