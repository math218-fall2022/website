...
subtitle: "due Tuesday, June 22 at 11:59p"
output: 
  tufte::tufte_html:
    highlight: pygments
    css: "sta199-labs.css"
...
simulation procedures and the Central Limit Theorem. The data for today's lab may be found by cloning your repository available at the class GitHub repository.
...
```{marginfigure}
**Hint**: To perform a test for independence of two numerical variables, we 
`hypothesize(null = "independence")`. Additionally, the type of simulation that
is generated is neither bootstrap nor simulate...
```
