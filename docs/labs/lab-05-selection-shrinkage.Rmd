...
## Exercise 2: practicing various methods

In this exercise we will generate simulated data and then examine the fit of different models to this data.
...
b) Split your data into a training set of 100 observations and a test set containing 900 observations.
