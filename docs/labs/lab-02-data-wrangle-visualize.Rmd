...
*You’re done! Knit, commit all remaining changes using the commit message “Done with Lab 2!”, and push. Before you wrap up the assignment, make sure the .Rmd and .md documents are updated in your GitHub repo.*
