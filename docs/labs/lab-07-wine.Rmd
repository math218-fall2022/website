...
5. Maybe we are interested in the point-to-price ratio. Create a new variable which describes this ratio. 
...
is usually better than a cheap red, but that an expensive red is always better than an expensive white.

Using an appropriate method of your choice, comprehensively evaluate the hypothesis 
...
What conclusion would you make at the $\alpha = 0.05$ level? At the $\alpha = 0.10$ level?
...
8. Plot and describe the distribution of the `points` of wine.
