...
2. Create a **data frame** that has two columns. The first column will be called `obs`, and should hold the 9 elements you created in Exercise 1. The second column will be called `var` and should hold the corresponding values of `x`, `y`, and `z`. Try to make this as reproducible as possible!
