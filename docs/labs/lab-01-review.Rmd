...
```{marginfigure}
Hint: look up the `apply()` function by typing `?apply` in the console. The example are particularly useful, but don't forget to read the Description, Usage, and Arguments sections first!
