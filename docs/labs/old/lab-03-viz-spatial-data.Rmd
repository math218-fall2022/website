...
subtitle: "Denny's and LaQuinta Inn Hotel and Suites"
author: "Total: 100 points"
date: "due Wed, Sep 18 at 11:59p"
output: 
  tufte::tufte_html: 
...
```{r fig.margin=TRUE, eval=FALSE, echo=FALSE}
include_graphics("img/03-viz-sp-data/mitch-hedgeberg-lqd.jpg")
```

Today's lab is based on a joke by the late comedian [Mitch Hedberg](https://en.wikipedia.org/wiki/Mitch_Hedberg). He observed that he often saw Denny's restaurants next to La Quinta Inn and Suites hotels whenever he traveled. If you're not familiar with these two establishments, [Denny's](https://www.dennys.com/) is a casual diner chain that is open 24 hours and [La Quinta Inn and Suites](http://www.lq.com/) is a hotel chain.
...
- Go to the course organization on GitHub: [https://github.com/sta199-fa19](https://github.com/sta199-fa19)
...
lq %>%
  mutate(country = case_when(
    state %in% states$abb     ~ "United States",
