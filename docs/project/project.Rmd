...
|--------------------------	|-----------	|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	|
| Introduction & EDA 	| 5 	| Is the research question, motivation for the analysis, and data clearly described? Are univariate distributions in the data clearly visualized and described using the appropriate summary statistics? Are relevant and interesting bivariate/multivariate relationships clearly visualized and described using the appropriate summary statistics?
	|
| Statistical Inference 	| 8	| Are appropriate statistical inference procedures carried out and explained thoroughly and correctly? This includes stating hypotheses (if needed), showing all relevant output, checking appropriate assumptions (if needed). Are the conclusions correct and written in context of the data and research question?
 	|
...
| Time Mangement 	| 2 	| Team divided the time well, stayed within the 8 minute time limit, and all team members spoke. 	|
