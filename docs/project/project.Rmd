...
Project plans due **Sunday, November 20 at 11:59pm**
...
This project is *partner-optional*. The partners will be self-selected. If you choose 
to complete the project with a partner, one of you should e-mail me and CC your partner on the e-mail by **Sunday, November 6 at 11:59pm**. 
...
Your project may be a supervised and/or unsupervised analysis. Whichever you choose, your project must consist of one of the following:
  ...
  - An analysis that uses at least three different statistical learning methods you learned this semester. This may be a comparison of three methods, or perhaps a comparison of two with a deeper dive into one. This is quite open-ended! *If you are working with a partner, you must use at least four different methods.*
  
  - An analysis that uses a method that you taught yourself or learned in a different class/setting. If you'd like, you may compare this method to another we learned in class, but that is not necessary. *If you are working with a partner, you must use compare this new method to another method.*
...
explored. As such, your dataset must have at least 100 observations and at  
least 10 variables. Generally,
more observations or more variable will lead to a more interesting analysis.
The dataset’s variables should include categorical variables, discrete numerical 
variables, and continuous numerical variables  (exceptions can be made but you must speak with me first). If you'd like, you may joint multiple datasets together.
...
that will output the proposal, plan of analysis, and final write-up in two separate documents
