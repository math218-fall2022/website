...
subtitle: "due Wed, June 30 at 11:59p"
output: 
  tufte::tufte_html:
...
In Exercises 7 - 11, determine whether the statements are TRUE or FALSE. If the 
...
difference in means.
11. If we instead found a p-value of 0.021, then at the $\alpha = 0.05$ level,
