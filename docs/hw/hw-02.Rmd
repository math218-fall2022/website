...
Attend office hours or use Piazza to ask questions about the assignment. 

You are also welcome to discuss the homework with each other broadly (no sharing code!) as well as ask questions at office hours.
...
The Duke Community Standard applies and course academic integrity policies apply. Please review them [here](http://www2.stat.duke.edu/courses/Fall19/Sta199/policies/#academic-integrity). Specifically, the note on sharing / reusing code.
...
Narrative in clear and complete sentences                       | 6 pts
