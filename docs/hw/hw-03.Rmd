...
3. Fit a linear main effects model to predict average `life expectancy` using the following variables: `schooling`, `status`, `GDP`, `adult_morality`. Write out the equation of the fitted model, and interpret all the coefficients.
