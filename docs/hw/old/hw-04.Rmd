...
You are also welcomed to discuss the homework with each other broadly, but no sharing code!
...
The Duke Community Standard applies and course academic integrity policies apply. Please review them [here](https://www2.stat.duke.edu/courses/Fall19/sta199.001/policies.html). Specifically, the note on sharing / reusing code.
