...
2. Create a visualization similar to, though not necessarily exactly the same as, the one shown on the [Wikipedia page](https://en.wikipedia.org/wiki/Gender_pay_gap). Interpret what the plot.
