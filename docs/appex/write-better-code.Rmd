...
1. What makes this code inefficient and/or not reproducible? How can the code be improved?

2. Write revised code to calculate the relative frequency of `cut` for each level of `color`. 

**[Click here](write-better-code-solutions.html) for example of revised code.**
...
2. Write revised code to find the `color` with the highest median price.
