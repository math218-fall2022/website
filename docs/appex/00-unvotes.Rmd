...
1. Change the country names in parts 1 and 2 to those that interest you. The spelling and capitalization must match what's in the data, so you can use the [Appendix](#appendix) to see the correct spelling and capitalization.

2. Knit again. 

You made your first data visualization!
