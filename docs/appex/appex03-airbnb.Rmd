...
The data contains information about Airbnb listings in Madrid, Spain. The data originally come from [Kaggle](https://www.kaggle.com/thoroc/edinburgh-inside-airbnb/version/2), and it has been modified for this exercise. 
...
The `madbnb` data set set has `r nrow(madbnb)` observations (rows).
