...
- Go to the course GitHub organization: https://github.com/sta199-summer2021. 
...
- Go to the [course organization](https://github.com/sta199-summer2021) on GitHub  and find the repo with the prefix **ae-02-**. 
...
Follow along with the instructions in **app02-flint.Rmd**. An html version of the file can be found [here](https://sta199-summer2021.github.io/website/appex/ae01-flint.html).
