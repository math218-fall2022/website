...
```{r}
boot_dist %>%
  summarise(lower_bound = quantile(stat, 0.025),
...
.question[
**We are 95% confident that the mean price per guest per night for Airbnbs in Asheville, NC is between `r round(lower_bound,1)` and `r round(upper_bound,1)` dollars. **
]