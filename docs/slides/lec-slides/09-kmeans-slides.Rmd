...
- Fit $k$-means several times with different $k$ values, and plot the objectives values against the number of clusters $K$
...
- Run k-means with $k = 3$, and compare to true classes:
