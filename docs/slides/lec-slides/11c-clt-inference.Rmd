...
- [Exam 02](https://www2.stat.duke.edu/courses/Spring19/sta199.001/exam/exam-02.html) assigned after class, due Friday at 11:59p
...
- Question 5 thrown out. Note
    ...
    - $R^2$ is the variability in $Y$ explained by the model
