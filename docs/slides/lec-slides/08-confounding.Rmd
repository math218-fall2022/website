...
Recall that in previous lecture, we found:
...
knitr::kable(table(department, apply),align = "ccccc" )
```
...
We see that in Department A, it seems like admissions are biased against men! What's happening here?
