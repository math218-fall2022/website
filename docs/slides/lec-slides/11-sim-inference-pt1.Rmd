...
- .vocab[Null hypothesis ($H_0$):] "There is nothing going on"

Complication rate for this consultant is no different than the US average of 10%

--

- .vocab[Alternative hypothesis ($H_a$):] "There is something going on"
...
then we reject the null in favor of the alternative hypothesis. 
...
This is a conditional probability: "given that $H_0$: $p = 0.1$ is true, what would the the probability of observing $\hat{p} = 3/62$ or less?"
