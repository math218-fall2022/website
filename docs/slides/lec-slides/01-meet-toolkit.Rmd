...
- There are a lot Git commands and very few people know them all. 99% of the time you will use git to add, commit, push, and pull.
...
- There is just a bit more of GitHub that we'll use in this class, but this is enough for now
