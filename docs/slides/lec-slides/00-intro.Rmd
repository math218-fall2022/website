...
- Go to [http://bit.ly/sta199-sp19-join](http://bit.ly/sta199-sp19-join), and log in with your GitHub credentials.

- You should see a project called *UN Votes*. Click on the project name; this will create your copy of the project and launch it.

- Click "Save a Permanent Copy" to save a copy of project in your workspace.
...
- Go back to the file and change "author" to your name (in the  `yaml` -- we will discuss what this is at a later date). Knit again.
...
You have made your first data visualizaiton!
