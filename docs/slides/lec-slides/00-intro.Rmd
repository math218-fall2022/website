...
<i class="material-icons">calendar_today</i>&nbsp; Wed 10:30am-12:00pm
...
- <font class="vocab">Homework</font>: Individual assignments combining conceptual and computational skills.
...
- <font class="vocab">Final Project</font>: Project presented during the class on **Wednesday, July 21 9:00-10:15am**. You must complete the project and present in class to pass the course.
...
- <font class="vocab">Application Exercises</font>: Exercises usually started in class and completed by the next class. Check/no check grade.

--

- <font class="vocab">Data Visualization Examples</font>: Share a visualization that you find interesting. One or two presentations per week.
...
- You should bring a laptop to every lecture and lab session. 
...
- Fill out the **Getting To Know You Survey on Sakai** - due Sunday, 9/16 at 11:59pm

- Please make sure you have access to Sakai and Gradescope

- My office hours start next week: Wed, 10:30am-12:00pm and by appointment
