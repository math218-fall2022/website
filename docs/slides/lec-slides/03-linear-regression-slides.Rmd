...
- Recall residual standard error (RSE) $$\text{RSE} = \sqrt{\frac{1}{n-2}\text{RSS}} = \sqrt{\frac{1}{n} \sum_{i=1}^{n} (y_{i} - \hat{y}_{i})^2}$$
...
- Simple linear regression model for $\color{blue}{\text{age}}$ regression on $\color{blue}{\text{sex}}$:
