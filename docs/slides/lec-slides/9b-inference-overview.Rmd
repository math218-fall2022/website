...
ggplot(data = sim_data, mapping = aes(x = prop_diff)) +
  ...
  labs(title = "Difference in Proportion of Yawners ")
```
...
> **M&Ms, stat stars, LAW students, paranormal distribution, WAMS:** single population median

> **Fantastic4, JJJB, zuck(R)berg, the 9 lives, BlueTurtle:** single population proportion

> **EMS, Turquoise, ccbk, Baes 4 Bayes, ShiftHappens:** difference between two population means

> **Team Audit, PipeOperators, Stats Soulmates, Datan't You Know We're Team 1?, ACOJ:** difference between two population proportions

> **significantly different, 16EYES, TwoSquared, Motivated Seniors:** single population standard deviation
]]
...
.small[
.question[
Describe the simulation process for testing for the parameter assigned to your team. 
...
> **M&Ms, stat stars, LAW students, paranormal distribution, WAMS:** single standard deviation

> **Fantastic4, JJJB, zuck(R)berg, the 9 lives, BlueTurtle:** single population mean

> **EMS, Turquoise, ccbk, Baes 4 Bayes, ShiftHappens:** difference between two population proportions

> **Team Audit, PipeOperators, Stats Soulmates, Datan't You Know We're Team 1?, ACOJ:** difference between two population medians

> **significantly different, 16EYES, TwoSquared, Motivated Seniors:** single population medians
]]
