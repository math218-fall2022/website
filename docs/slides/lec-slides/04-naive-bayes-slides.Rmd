...
- If $X_{j}$ is quantitative, then another option is to use a non-parametric estimate for $f_{kj}$
...
- Recall that normal distribution is symmetric, bell-shaped curve 
