...
- We can also calculate summary statistics and perform data wrangling/manipulation/transformation at (or before) this stage of the analysis. That's what we're focusing in next class.
...
- **Insert instructions for getting exercise from GitHub**
...
- **outliers**, i.e. unusual observations
