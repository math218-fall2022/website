...
- By the end of today's lab: 
    ...
    - Find a **weekly 2-hour block between Thursday and Tuesday** that the team can meet to finish lab. You may not need to use the time every week, but it will be helpful to already have a plan for the weeks that you do need extra time.
