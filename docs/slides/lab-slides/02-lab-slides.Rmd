...
- There will be periodic writing assignments this semester to give you an opportunity to practce...
    - communicating statistical ideas in writing
    - giving and receiving constructive feedback to help refine your writing skills

- Each writing assignment will consist of three parts (about 15 minutes each): 
...
- Writing exercises are 5% fo the final course grade
...
- The first writing exercise is about data visualization and wrangling. 
    ...
    - Peer review - due Satruday at 11:59p
...
- If you finish lab early, you can go ahead and work on the first writing exercise. Otherwise, I will let you know when there are 15 minutes left in lab, so you can work on the first response before you leave.
...
- Once you've completed the warmup read through the tips on the next slide. You are then ready to start working on the rest of lab.
    - **Remember: only one person should update the files.**
