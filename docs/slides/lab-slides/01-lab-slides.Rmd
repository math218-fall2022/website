...
- Dr. Julie Reynolds, Associate Professor of the Practice in Biology: [julie.a.reynolds@duke.edu](mailto:julie.a.reynolds@duke.edu)

- Survey & Consent: You should have received an email this morning with a link to the survey. If you did not receive the email, you may access the survey here: [https://duke.qualtrics.com/jfe/form/SV_eF07ubGm219RAoJ](https://duke.qualtrics.com/jfe/form/SV_eF07ubGm219RAoJ)
...
- When working in teams, do not split up the lab among the team members; work on it together in its entirety (more on this next week).
...
- Go to RStudio Cloud and into the STA199-FA19 course workspace. Create a **New Project from Git Repo**. You will need to click on the down arrow next to the **New Project** button to see this option.
